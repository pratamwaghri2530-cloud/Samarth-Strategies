...
const MESSAGES = [
  { id: 0, from: "patient", text: "Hi, I need to book an appointment" },
  {
    id: 1,
    from: "bot",
    text: "Good evening! 🙏 Welcome to HSC Chiropractic.\nIs this your first visit?",
  },
  { id: 2, from: "patient", text: "Yes, first time" },
  {
    id: 3,
    from: "bot",
    text: "Please share: Patient name,\nAge, Address & Reference 📋",
  },
  { id: 4, from: "patient", text: "Rahul Sharma, 35, Mumbai" },
  {
    id: 5,
    from: "bot",
    text: "✅ Slot confirmed for Tomorrow 2PM!\nPayment link sent. 🙏",
  },
];

// Timing (ms from start of each cycle)
const SCHEDULE = [
...
export default function WhatsAppDemo() {
  ...
  return (
    <section className="py-20 md:py-32 reveal" style={{ background: "#13131A" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <span
              className="inline-block text-xs font-sans font-medium uppercase tracking-[0.15em] mb-4 px-3 py-1 rounded-full"
            ...
            <h2
              ...
              style={{ fontSize: "clamp(28px, 4vw, 48px)", color: "#F0EEE9" }}
            >
              See AI Automation
              <br />
              <span style={{ color: "#F97316" }}>in Action</span>
            </h2>
            <p className="mb-8 leading-relaxed" style={{ color: "rgba(240,238,233,0.65)", fontSize: "18px" }}>
            ...
            <div
              ...
              style={{ background: "rgba(240,238,233,0.05)", border: "1px solid rgba(249,115,22,0.2)" }}
            >
              <div className="pulse-dot" />
              <p className="font-sans" style={{ color: "rgba(240,238,233,0.7)", fontSize: "14px" }}>
                <span style={{ color: "#F0EEE9", fontWeight: 600 }}>Response time: 3 seconds.</span>
                {" "}Previously: 14 hours.
              </p>
            </div>
          </div>
          ...
          <div className="flex justify-center items-center">
            ...
            <div
              ...
              style={{
                ...
                background: "#0D0D0D",
                borderRadius: "40px",
                border: "3px solid rgba(240,238,233,0.12)",
            ...
            >
              ...
              <div
                ...
                style={{ height: "28px", background: "#0D0D0D", paddingTop: "6px" }}
              >
              ...
              >
                {MESSAGES.map((msg, i) => {
                  ...
                  return (
                    <div
                      key={msg.id}
                      className={`chat-msg ${isVisible ? "visible" : ""}`}
                      style={{
                        display: "flex",
                    ...
                    >
                      ...
                      >
                        {msg.text}
                        <span style={{ display: "block", fontSize: "9px", color: "#999", textAlign: "right", marginTop: "2px" }}>
                          {isPatient ? "✓✓" : ""}
                        </span>
                      </div>
                    </div>
                ...
                {/* Typing indicator */}
                <div
                  className={`chat-typing ${showTyping && !fading ? "visible" : ""}`}
